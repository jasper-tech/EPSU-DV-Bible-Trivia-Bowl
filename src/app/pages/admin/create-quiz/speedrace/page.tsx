...
const SpeedRace = () => {
  ...
  const handleSubmitQuiz = async () => {
    ...
    try {
      ...
      // Append "- SpeedRace" to the quiz title
      const formattedTitle = `${quizTitle} - SpeedRace`;
      ...
      toast.success("SpeedRace quiz created successfully!");
      console.log("SpeedRace quiz created with ID:", docRef.id);
      ...
      toast.error("Failed to create SpeedRace quiz.");
    } finally {
      setSubmitting(false);
    }
  };
  ...
  return (
    <Box className="p-4">
      ...
      {questions.length === 0 ? (
        ...
        <Paper
          elevation={2}
          sx={{ overflowY: "auto", maxHeight: "400px", mb: 3 }}
        >
      ...
      <Button
        ...
        sx={{ mt: 2 }}
      >
        {submitting ? "Creating..." : "Create SpeedRace Quiz"}
      </Button>
    </Box>
  );
};
