    ...
    <section className="bg-gradient-to-br from-white to-blue-50 shadow-md p-8 rounded-2xl w-full max-w-4xl mx-auto border border-blue-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8">
        ...
        <div
          ...
          className={`
            ...
            ${
              isHovered === "quiz" && !isQuizDisabled
                ? "transform hover:-translate-y-2 shadow-lg"
                : "shadow-md"
            }
          `}
        >
          ...
          >
            <FaBible
              className={`${
                isQuizDisabled ? "text-gray-600" : "text-white"
              } text-4xl`}
            />
          </div>
          ...
          {activeQuiz && !isQuizDisabled && (
            <div className="mt-2">
              <span className="inline-flex items-center bg-gradient-to-r from-orange-500 via-red-500 to-yellow-400 text-white text-xs font-bold px-3 py-1 rounded-full animate-pulse gap-1 shadow-lg shadow-orange-400/50">
        ...
        >
          ...
          <h3 className="text-2xl font-bold mb-3 text-yellow-800">
            Leaderboard
          </h3>
          <p className="mb-4 text-yellow-700">
            See the top scorers and your ranking!
          </p>
          <div className="mt-5 w-full bg-gray-200 rounded-full h-2.5">
      ...
      <div className="mt-10 text-center">
        <p className="text-gray-600 italic">
          &quot;Test your knowledge, strengthen your faith&quot;
        </p>
      </div>
    </section>
  );
